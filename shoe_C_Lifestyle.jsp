...
<body>
<h1 style='position: fixed; bottom: 0; font-size: 28rem; opacity: 0.05;'>Lifestyle</h1>
<h1 style='color:#FF7F3F; position: fixed; left: 2%; bottom: 4%; font-size: 28rem; opacity: 0.05;'>Lifestyle</h1>		
<h1 style='position: fixed; left: 4%; bottom: 8%; font-size: 28rem; opacity: 0.025;'>Lifestyle</h1>		
<h1 style='position: fixed; left: 6%; bottom: 12%; font-size: 28rem; opacity: 0.012;'>Lifestyle</h1>		
<h1 style='position: fixed; left: 8%; bottom: 16%; font-size: 28rem; opacity: 0.006;'>Lifestyle</h1>		
<h1 style='position: fixed; left: 10%; bottom: 20%; font-size: 28rem; opacity: 0.003;'>Lifestyle</h1>

<h1 style="display: inline; position: fixed; top: 12%; left: 50%; font-size: 5rem; font-weight: 500">Lifestyle</h1>
<h1 style="display: inline; position: fixed; top: 13%; left: 50.5%; font-size: 5rem; font-weight: 500; opacity:0.2">Lifestyle</h1>
	<%
			...
			while(rs.next()) {
				...
				out.println("<div class='content' value='" + shoeName + "'>"
						...
						+ "<img class='content-test1' width=500px src='" + shoeImgSrc + "'>"
							...
							+ "<button class='buyNow-Btn content-test1 btn-primary' style='position: relative; bottom: 100px;' value='" + shoeName + "'>Buy Now</button>"
						+ "</div>");
				i++;
			}
		%>
