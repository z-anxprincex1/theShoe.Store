...
<h1 style='position: fixed; bottom: 0; font-size: 28rem; opacity: 0.05;'>Jordans</h1>
<h1 style='color:#548CFF; position: fixed; left: 2%; bottom: 4%; font-size: 28rem; opacity: 0.05;'>Jordans</h1>		
<h1 style='position: fixed; left: 4%; bottom: 8%; font-size: 28rem; opacity: 0.025;'>Jordans</h1>		
<h1 style='position: fixed; left: 6%; bottom: 12%; font-size: 28rem; opacity: 0.012;'>Jordans</h1>		
<h1 style='position: fixed; left: 8%; bottom: 16%; font-size: 28rem; opacity: 0.006;'>Jordans</h1>		
<h1 style='position: fixed; left: 10%; bottom: 20%; font-size: 28rem; opacity: 0.003;'>Jordans</h1>

<h1 style="display: inline; position: fixed; top: 12%; left: 50%; font-size: 5rem; font-weight: 500">Jordans</h1>
<h1 style="display: inline; position: fixed; top: 13%; left: 50.5%; font-size: 5rem; font-weight: 500; opacity:0.2">Jordans</h1>
	<%
